...
2. ✅ **OTIF trend report** per Anand's comment (row 5) — Overall / B2C / B2B, Apr–Jun avg + current month. No store-level. *(Implemented on Reports in the v3.2 mockup round.)*
...
| 5 | OTIF publishing + trend (Overall + B2C/B2B only) | ✅ | `s-rep` report card + table completed |
